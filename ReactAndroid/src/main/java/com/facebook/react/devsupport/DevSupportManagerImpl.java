...
public class DevSupportManagerImpl implements DevSupportManager, PackagerCommandListener {
        ...
        new Runnable() {
          ...
          public void run() {
            ...
            if (Build.VERSION.SDK_INT >= Build_VERSION_CODES_O) {
              mRedBoxDialog.getWindow().setType(WindowManager_LayoutParams_TYPE_APPLICATION_OVERLAY);
            }
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M)
            {
  ...
  public void showDevOptionsDialog() {
    ...
    if (Build.VERSION.SDK_INT >= Build_VERSION_CODES_O) {
      mDevOptionsDialog.getWindow().setType(WindowManager_LayoutParams_TYPE_APPLICATION_OVERLAY);
    }
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M)
    {
      mDevOptionsDialog.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_ALERT);
  ...
  public void handleReloadJS() {
    ...
    if (Build.VERSION.SDK_INT >= Build_VERSION_CODES_O) {
      dialog.getWindow().setType(WindowManager_LayoutParams_TYPE_APPLICATION_OVERLAY);
    }
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M)
    {
      dialog.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_ALERT);
